...
func (ec *DashElectrumClient) SyncWallet(ctx context.Context) error {
	w := ec.GetWallet()
	if w == nil {
		return ErrNoWallet
	}
...
func (ec *DashElectrumClient) RpcBroadcast(ctx context.Context, tx string) (string, error) {
...
// the wallet.
func (ec *DashElectrumClient) Broadcast(ctx context.Context, rawTx []byte) (string, error) {
...
func (ec *DashElectrumClient) ListUnspent() ([]wallet.Utxo, error) {
	w := ec.GetWallet()
	if w == nil {
		return nil, ErrNoWallet
	}
...
func (ec *DashElectrumClient) ListConfirmedUnspent() ([]wallet.Utxo, error) {
	w := ec.GetWallet()
	if w == nil {
		return nil, ErrNoWallet
	}
...
func (ec *DashElectrumClient) ListFrozenUnspent() ([]wallet.Utxo, error) {
	w := ec.GetWallet()
	if w == nil {
		return nil, ErrNoWallet
	}
...
func (ec *DashElectrumClient) ValidateAddress(addr string) (bool, bool, error) {
	w := ec.GetWallet()
	if w == nil {
...
func (ec *DashElectrumClient) Balance() (int64, int64, int64, error) {
	w := ec.GetWallet()
	if w == nil {
...
func (ec *DashElectrumClient) FreezeUTXO(txid string, out uint32) error {
	w := ec.GetWallet()
	if w == nil {
		return ErrNoWallet
	}
...
func (ec *DashElectrumClient) UnfreezeUTXO(txid string, out uint32) error {
	w := ec.GetWallet()
	if w == nil {
		return ErrNoWallet
	}
...
func (ec *DashElectrumClient) FeeRate(ctx context.Context, confTarget int64) (int64, error) {
