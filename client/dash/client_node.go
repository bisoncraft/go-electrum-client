...
func (ec *DashElectrumClient) GetRawTransaction(ctx context.Context, txid string) ([]byte, error) {
	node := ec.GetX()
	if node == nil {
...
func (ec *DashElectrumClient) GetTransaction(ctx context.Context, txid string) (*electrumx.GetTransactionResult, error) {
	node := ec.GetX()
	if node == nil {
		return nil, ErrNoElectrumX
	}
...
func (ec *DashElectrumClient) GetAddressHistory(ctx context.Context, addr string) (electrumx.HistoryResult, error) {
	node := ec.GetX()
	if node == nil {
		return nil, ErrNoElectrumX
	}
...
func (ec *DashElectrumClient) GetAddressUnspent(ctx context.Context, addr string) (electrumx.ListUnspentResult, error) {
	node := ec.GetX()
	if node == nil {
		return nil, ErrNoElectrumX
	}
