...
func (ec *DashElectrumClient) getWitnessScriptHashRedeemUtxos(_ context.Context /*keyPair*/, _ *btcutil.WIF) ([]wallet.InputInfo, error) {
	utxoList := make([]wallet.InputInfo, 0)
	return utxoList, nil
}

func (ec *DashElectrumClient) getScriptHashRedeemUtxos(_ context.Context /*keyPair*/, _ *btcutil.WIF) ([]wallet.InputInfo, error) {
	utxoList := make([]wallet.InputInfo, 0)
	return utxoList, nil
}

func (ec *DashElectrumClient) getPubKeyUtxos(_ context.Context, _ *btcutil.WIF) ([]wallet.InputInfo, error) {
	utxoList := make([]wallet.InputInfo, 0)
	return utxoList, nil
}
