...
func (ec *DashElectrumClient) addSubscription(subscription *wallet.Subscription) error {
	w := ec.GetWallet()
	if w == nil {
		return ErrNoWallet
	}
...
func (ec *DashElectrumClient) getSubscriptionForScripthash(scripthash string) (*wallet.Subscription, error) {
	w := ec.GetWallet()
	if w == nil {
...
func (ec *DashElectrumClient) getSubscription(scriptPubKey string) (*wallet.Subscription, error) {
	w := ec.GetWallet()
	if w == nil {
		return nil, ErrNoWallet
	}
...
// the wallet db
func (ec *DashElectrumClient) isSubscribed(pkScript string) (bool, error) {
	w := ec.GetWallet()
	if w == nil {
...
func (ec *DashElectrumClient) removeSubscription(pkScript string) error {
	w := ec.GetWallet()
	if w == nil {
		return ErrNoWallet
	}
...
func (ec *DashElectrumClient) addressStatusNotify(ctx context.Context) error {
	node := ec.GetX()
...
func (ec *DashElectrumClient) SubscribeAddressNotify(ctx context.Context, newSub *wallet.Subscription) (string, error) {
	node := ec.GetX()
	if node == nil {
...
func (ec *DashElectrumClient) UnsubscribeAddressNotify(ctx context.Context, pkScript string) {
	node := ec.GetX()
	if node == nil {
		return
	}
...
// subscribed address.
func (ec *DashElectrumClient) GetAddressHistoryFromNode(ctx context.Context, subscription *wallet.Subscription) (electrumx.HistoryResult, error) {
	node := ec.GetX()
	if node == nil {
...
// history list.
func (ec *DashElectrumClient) GetRawTransactionFromNode(ctx context.Context, txid string) (*wire.MsgTx, time.Time, error) {
	node := ec.GetX()
	if node == nil {
...
func (ec *DashElectrumClient) addTxHistoryToWallet(ctx context.Context, history electrumx.HistoryResult) {
...
func (ec *DashElectrumClient) pkScriptToAddressPubkeyHash(pkScript []byte) (btcutil.Address, string) {
...
func (ec *DashElectrumClient) updateWalletTip(tip int64) {
	w := ec.GetWallet()
	if w != nil {
		w.UpdateTip(tip)
	}
...
// dbg dump
// /////////
// func (ec *DashElectrumClient) dumpSubscription(title string, sub *wallet.Subscription) {
...
// func (ec *DashElectrumClient) dumpHistory(sub *wallet.Subscription, history electrumx.HistoryResult) {
